...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        assertEquals(null, IntList.reverseRecursively(null));
        ...
        assertEquals(exp, IntList.reverseRecursively(B));

        assertEquals(A, IntList.list(1));
        assertEquals(B, IntList.list(1));
